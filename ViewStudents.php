...
if (mysqli_num_rows($result) > 0) {
  ...
  $numm++;
		...
		echo "</td>";
		echo "<td><a href='verify.php?edit=$row[studID]' target='$numm' style='color:#096;'><u>Verify</u></a>";
		echo "<td><iframe name='$numm' width='100px' height='30px' scrolling='no' frameborder='0'></iframe></td>";
		echo "</tr>";		
   	 }
} else {
    echo "0 results";
